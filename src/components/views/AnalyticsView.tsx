...
import { StatsExport } from "@/app/app/estadisticas/StatsExport";
import type { AnalyticsData } from "@/server/services/stats";

/** Estadísticas, compartidas por /app y por la demo pública /demo. */
export function AnalyticsView({
  a, businessName, basePath = "/app",
}: {
  a: AnalyticsData;
  businessName: string;
  basePath?: string;
  ...
  return (
    <div>
      <PageHeader
        ...
        actions={<StatsExport analytics={a} businessName={businessName} />}
      />
